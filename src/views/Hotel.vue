...
<template>
  <div class="h-[60px] bg-[#0068EF]"></div>
  <div v-if="hotelData">
    <div class="h-[46px] bg-[#C3D7F3] flex items-center">
      <div class="flex items-center gap-2 container text-[13px]">
        ...
        See all Hotels in {{ hotelData.city }}
      </div>
    </div>
    ...
    />
    <div class="h-[219px] bg-[#e8e9f3]">
      <div class="container h-full">
        <h1 class="text-[26px] font-[600] pt-[60px] pb-[5px]">Your Search</h1>
      </div>
    </div>
    <div class="container">
      <Rooms :rooms="hotelData.rooms" :externalLinks="hotelData.externalLinks" />
    </div>
  </div>
</template>
